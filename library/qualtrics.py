...
def select_valid_rows(
    survey: pd.DataFrame, keep_previews: bool = False, min_duration: int = 45
):
...
def search_column_labels(
    column_labels: dict, search_term: str, print_col: bool = False
):
...
def replace_missing_text(df: pd.DataFrame, columns: list, replace_str: str = ""):
