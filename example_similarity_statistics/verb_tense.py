...
script1 = "To make your next simulation even stronger, I want you to focus on making your redirections more specific so that students know exactly what you want them to stop doing or start doing. This helps us make sure that students aren’t confused. For example, I noticed in your last simulation that you told Dev to pay attention. The words pay attention can be confusing because it can mean different things for different people and you can’t see if a student is following those directions. Next time Dev has a side conversation I want you to tell them exactly what you want to see. For example, you could say: Dev, voice off, hands together."
